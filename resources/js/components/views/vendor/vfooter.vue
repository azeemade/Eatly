<template>
    <div>
        <div class="d-flex justify-content-around">
            <router-link :to="{ path: '/vendor/'+$route.params.shop_name+'/home'}" class="text-center footer-link">
                <div>
            ...
            <router-link to="/vendor/meals" class="text-center footer-link">
                <div>
            ...
            <router-link :to="{path: '/vendor/orders?pid='+$store.state.id}" class="text-center footer-link">
                <div>
            ...
            <router-link to="/message" class="text-center footer-link">
                <div>
...
<style scoped>
    ...
    .router-link-exact-active.router-link-active.footer-link {
        color: black;
    }
    .router-link-exact-active.router-link-active.footer-link > div p.indicator {
        display: block;
    }
</style>