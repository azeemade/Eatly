<template>
    <div>
        ...
        <li class="mb-3 d-flex btn"> 
            ...
            <router-link to="/vendor/home">Home</router-link>
        </li>
        <li class="mb-3 d-flex btn">
            <div class="mr-3">
            ...
            <router-link :to="{path: '/vendor/meals?pid='+shop.id}">My meals</router-link>
        </li>
        <li class="mb-3 d-flex btn">
            <div class="mr-3">
            ...
            <router-link :to="{path: '/vendor/orders?pid='+shop.id}">Orders</router-link>
        </li>
        <li class="mb-3 d-flex btn">
            <div class="mr-3">
            ...
            <router-link to="/vendor/earnings">Earning</router-link>
        </li>
    </div>
</template>
<script>
