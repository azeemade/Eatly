<template>
    <div>
        <div class="modal right fade" tabindex="-1" role="dialog" aria-labelledby="accountLabel" :id="target">
                    ...
                    <div class="modal-body mb-5">
                        <div class="user-info-section">
                            <div class="text-center">
                                <img :src="'/images/'+ user.user_image + '.png'" alt="" width="75"  height="75" class="rounded-circle">
                                <div>
                            ...
                            <div>
                                <button class="btn user-edit-btn" data-dismiss="modal">
                        ...
                        <div>
                            <ul class="pl-0 mt-5 mb-2">
                                <li class="account-list pb-2 mb-2 hide-md">
                                    <router-link to="/favourites/meal" class="btn justify-content-between d-flex" data-dismiss="modal">
                                        <div class="d-flex">
                                            <div class="mr-3">
                                ...
                                <li class="account-list pb-2 mb-2">
                                    <router-link to="/history" class="btn justify-content-between d-flex" data-dismiss="modal">
                                        <div class="d-flex">
                                            <div class="mr-3">
                                ...
                                <li class="account-list pb-2 mb-2">
                                    <router-link to="/settings" class="btn justify-content-between d-flex" data-dismiss="modal">
                                        <div class="d-flex">
                                            <div class="mr-3">
                                ...
                                <li class="account-list pb-2 mb-2">
                                    <router-link to="/terms" class="btn justify-content-between d-flex" data-dismiss="modal">
                                        <div class="d-flex">
                                            <div class="mr-3">
                                            ...
                                            <div>
                                                <p class="mb-0">Terms and privacy policy</p>
                                            </div>
                                        </div>
                                        <div>
                                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-caret-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li class="account-list pb-2 mb-2">
                                    <router-link to="/help" class="btn justify-content-between d-flex" data-dismiss="modal">
                                        <div class="d-flex">
                                            <div class="mr-3">
                                ...
                                <li class="my-2 hide-md text-center">
                                    <div v-if="hasShop == `Yes`">
                                        <router-link to="/vendor/home" class="d-flex btn user-edit-btn btn-block">
                                            <div class="mr-3">
                                    ...
                                    <div v-if="hasShop == `No`"  class="d-flex">
                                        <router-link to="/recipes" class=" d-flex btn user-edit-btn btn-block">
                                            <div class="mr-3">
                                ...
                                <li class="text-center border-outline-danger">
                                    <button class="btn logout-btn btn-block" @click="logout" data-dismiss="modal">Logout</button>
                                </li>
                            </ul>
                        </div>
                    </div>
