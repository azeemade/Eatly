let actions = {
    setShopName({commit}, id) {
        let user_id = id
        axios.get(`/api/v1/shop/shop-name?user_id=${user_id}`)
            .then(res => {
    ...
    setShop({commit},id){
        let url = `/api/v1/shop/vendor?user_id=${id}`
        axios.get(url)
            .then(res => {
    ...
    fetchFavMeal({commit}, id) {
        let user_id = id
        axios.get(`/api/v1/favourite/meals?user_id=${user_id}`)
        //axios.get(`/api/v1/favourite/meals`)
            .then(res => {
    ...
    fetchFavShop({commit}, id) {
        let user_id = id
        axios.get(`/api/v1/favourite/shops?user_id=${user_id}`)
            .then(res => {
    ...
    fetchOpenOrders({commit}, id) {
        let user_id = id
        axios.get(`/api/v1/order/user/open?user_id=${user_id}`)
            .then(res => {
    ...
    fetchClosedOrders({commit}, id) {
        let user_id = id
        axios.get(`/api/v1/order/user/closed?user_id=${user_id}`)
            .then(res => {
    ...
    fetchUndelivered({commit}, id) {
        axios.get(`/api/v1/order/open/?user_id=${id}`)
            .then(res => {
    ...
    fetchDelivered({commit}, id) {
        axios.get(`/api/v1/order/closed/?user_id=${id}`)
            .then(res => {
    ...
    fetchComments({commit}, meal_slug) {
        //let meal_id = meal.id
        axios.get(`/api/v1/comment/?meal_slug=${meal_slug}`)
            .then(res => {
    ...
    fetchVendorMeals({commit}, shop_name) {
        axios.get(`/api/v1/meal/vendor?shop_name=${shop_name}`)
            .then(res => {
    ...
    fetchSale({commit}, meal) {
        let meal_id = meal.id
        axios.get(`/api/meal/sales?id=${meal_id}`)
            .then(res => {
    ...
    fetchVRating({commit}, meal) {
        let meal_id = meal.id
        axios.get(`/api/meal/rating?id=${meal_id}`)
        //axios.get(`/api/meal/sales?id=${meal_id}`)
            .then(res => {
    ...
    fetchRecent({commit}, id) {
        let user_id = id
        axios.get(`/api/v1/search/recent?user_id=${user_id}`)
            .then(res => {
    ...
    storeSearch({commit}, {id, search}) {
        let user_id = id
        let search_ = search
        axios.post(`/api/v1/search/create?user_id=${user_id}&search_title=${search_}`)
            .then(res => {
    ...
    clearRecent({commit}, id) {
        let user_id = id
        axios.delete(`/api/v1/search/clear?user_id=${user_id}`)
            .then(res => {
    ...
    fetchUser({commit}, id){
        let url = `/api/v1/user/show?user_id=${id}`
        axios.get(url)
        .then(res => {
    ...
    editingMeal({commit}, meal_slug){
        let url = `/api/v1/meal/edit/?meal_slug=${meal_slug}`
        axios.get(url)
        .then(res => {
